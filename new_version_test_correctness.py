...
Lower_bds, Upper_bds,  objective = collect_all_upper_lower(model,X,Y,Epsilon)
start = time.time()
test_y = check_corectness(test_num = 100000, epsilon = Epsilon , X = x, net = model, upper = Upper_bds[-1], lower = Lower_bds[-1])
end = time.time()
