...
def get_args():
    ...
    parser.add_argument('--mean', nargs='+', help='mean value of dataset, default (0.5,) for mnist (0.485, 0.456, 0.406) for cifar10', type=float)
    parser.add_argument('--std', nargs='+', help='std value of dataset, default (0.5, ) for mnist, (0.229, 0.224, 0.225) for cifar10', type=float)
